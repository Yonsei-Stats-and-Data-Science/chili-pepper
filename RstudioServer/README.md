...
On a client webbrowser, go to `http://<server-public-ip>:8787`. As the default authenticator is PAM, login with *preexisting system-wide* username and password. RStudio server will open in the user's home directory.
